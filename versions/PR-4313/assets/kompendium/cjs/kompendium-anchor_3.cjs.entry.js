...
const anchorCss = () => `:host{display:inline}.anchor{display:inline;margin-left:0.25em;color:rgb(var(--kompendium-contrast-700));text-decoration:none;font-size:inherit;font-weight:inherit;line-height:inherit;opacity:var(--kompendium-anchor-opacity, 0);transition:opacity 0.2s ease, color 0.2s ease}.anchor:hover,.anchor:focus-visible{color:rgb(var(--kompendium-color-blue-default));opacity:1}.anchor.active{color:rgb(var(--kompendium-color-blue-default));opacity:1}`;
...
const Anchor = class {
    ...
    render() {
        return (index.h("a", { key: 'ebbe73e04e41b32353275d538aaaa2faaf4b9b00', class: { anchor: true, active: this.active }, href: anchors.anchorHref(this.slug), "aria-label": `Link to ${this.label}`, onClick: this.handleClick }, "\u00B6"));
    }
    handleHashChange() {
        this.updateActive();
    }
    updateActive() {
        this.active = anchorScroll.getAnchorId() === this.slug;
    }
};
...
const Proplist = class {
    ...
    render() {
        return index.h("dl", { key: 'bfac216b395a349661b91d2cfea7c56896c17a53' }, this.items.map(this.renderProperty));
    }
...
exports.kompendium_anchor = Anchor;
