...
const Playground = class {
    ...
    renderTab(source, index$1) {
        ...
        return (index.h("a", { class: classList, onClick: this.activateTab(source.filename) }, source.filename));
    }
    renderItems(sources) {
    ...
    renderResult() {
        ...
        return (index.h("div", null, index.h("kompendium-markdown", { text: text }), index.h(ExampleComponent, null)));
    }
    renderItem(source, index$1) {
        ...
        return (index.h("kompendium-code", { random: Math.random(), class: classList, language: source.type }, code));
    }
...
const Proplist = class {
    ...
    renderProperty(property) {
        ...
        return [
            index.h("dt", null, key),
            index.h("dd", { class: `value--${value}` }, index.h("code", null, value)),
        ];
    }
};
