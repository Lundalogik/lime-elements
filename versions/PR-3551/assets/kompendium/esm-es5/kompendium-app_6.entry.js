...
import { r as registerInstance, h, g as getAssetPath, c as getElement, e as getContext } from './index-2f7cd895.js';
...
var App = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: "kompendium-body" }, h("kompendium-navigation", { menu: this.data.menu, header: this.data.title }), h("main", { role: "main" }, h("stencil-router", { historyType: "hash" }, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: "/", component: "kompendium-markdown", componentProps: {
...
var Navigation = /** @class */ (function () {
    ...
    Navigation.prototype.render = function () {
        return (h("nav", { class: "nav-panel" }, h("a", { class: "nav-panel__responsive-menu", onClick: this.toggleMenu }, h("span", { class: "show-nav" }, "|||"), h("span", { class: "hide-nav" }, "\u2A2F")), h("header", { class: "panel-header" }, h("h1", null, h("a", { href: "#" }, this.header)), h("kompendium-search", null)), this.renderChapters(this.menu)));
    };
    ...
    Navigation.prototype.renderMenuItem = function (item) {
        ...
        return (h("li", { class: "panel-item" }, h("a", { class: anchorClassList, href: '#' + item.path }, h("span", { class: "link-text" }, h("img", { src: path }), item.title)), h("ul", { class: classList }, chapters.map(this.renderMenuItem))));
    };
