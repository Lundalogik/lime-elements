...
| ---------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `dragDirection`        | `drag-direction`         | The direction in which the drag handle can be used to reorder items. This affects both how the visual indicator is visualized, and how what helper label is shown in the tooltip. | `"horizontal" \| "vertical"`                                                                                                                                         | `'vertical'` |
| `language`             | `language`               | Language to use for translations.                                                                                                                                                 | `"da" \| "de" \| "en" \| "fi" \| "fr" \| "nb" \| "nl" \| "no" \| "sv"`                                                                                               | `'en'`       |
| `tooltipOpenDirection` | `tooltip-open-direction` | The preferred direction for the tooltip to open. Defaults to 'left', as our recommended placement for a drag handel in the UI is on the far right side of draggable elements.     | `"bottom" \| "bottom-end" \| "bottom-start" \| "left" \| "left-end" \| "left-start" \| "right" \| "right-end" \| "right-start" \| "top" \| "top-end" \| "top-start"` | `'left'`     |
