...
const markdownTypes = require('./markdown-types-ce45d31e.js');
...
const App = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "kompendium-body" }, index.h("kompendium-navigation", { menu: this.data.menu, header: this.data.title, logo: this.data.logo }), index.h("main", { role: "main" }, index.h("stencil-router", { historyType: "hash" }, index.h("stencil-route-switch", { scrollTopOffset: 0 }, index.h("stencil-route", { url: "/", component: "kompendium-markdown", componentProps: {
...
const Navigation = class {
    ...
    render() {
        return (index.h("nav", { class: "nav-panel" }, index.h("a", { class: "nav-panel__responsive-menu", onClick: this.toggleMenu }, index.h("span", null), index.h("span", null), index.h("span", null), index.h("span", null)), index.h("header", { class: "panel-header" }, index.h("h1", null, this.renderHeader()), index.h("kompendium-search", null)), this.renderChapters(this.menu)));
    }
    renderHeader() {
