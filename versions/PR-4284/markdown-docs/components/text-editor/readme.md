...
| `regions`        | --             | Named block-level regions the editor should recognise in its value, each written as `<div data-lime-region="name">`. A region keeps its identity through the editor, so it can be replaced on its own with `replaceRegion` without disturbing the rest of the document.  Only available in `html` mode.                                                                                                                                                                                                                                                                                                                         | `EditorRegion[]`                                                       | `undefined`  |
...
### `replaceRegion(name: string, html: string) => Promise<void>`
...
| ------ | -------- | -------------------------- |
| `name` | `string` | - the region to replace    |
| `html` | `string` | - the region's new content |
...
### Used by
 ...
 - [limel-example-text-editor-regions](examples)
...
graph TD;
  ...
  limel-example-text-editor-regions --> limel-text-editor
