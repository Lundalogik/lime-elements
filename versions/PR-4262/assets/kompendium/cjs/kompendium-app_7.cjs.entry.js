...
var markdownTypes = require('./markdown-types-BY7ZkNa4.js');
...
const App = class {
    ...
    async fetchData() {
        ...
        markdownTypes.setComponents(componentTags);
    }
    render() {
        if (!this.data) {
...
const DarkmodeSwitch = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b98a56a2891f00eeafec12b07bb62bab656c648c', class: "mode-toggle" }, index.h("input", { key: 'b4a36d6c2ea06d86d6e17565914e5aa2bd0e63ce', type: "checkbox", onChange: this.handleThemeChange, ref: this.getSelectRef, ...props }), index.h("div", { key: '216d6c2a317904d26d5f534eacecabe8ff0da266', class: "mode-visualization" }, index.h("div", { key: '918e2891556bf40477c7ea7e787481e29edee5de', class: "circle" }), index.h("div", { key: 'a6406616e04afc792af316c28094cd1e1e68ab81', class: "ray one" }), index.h("div", { key: 'a18504838fe0f18c08cbacc728f957ab2f4bbdf5', class: "ray two" }), index.h("div", { key: '7a688bdf87865b0d054d33799fb40610f7fdf0d2', class: "ray three" }), index.h("div", { key: '53a646d5e27d1c18104d779a1326f5dbc89c4323', class: "ray four" }))));
    }
};
...
const Navigation = class {
    ...
    render() {
        return [
            index.h("div", { key: '73b5ead76c3caebf82f92f0446f1fd2d8ef34c9a', class: {
                    'nav-panel-scrim': true,
                    'display-nav-panel': this.displayNavPanel,
                }, onClick: this.toggleMenu }),
            index.h("nav", { key: 'de2d992290cc30bead85cd1c72f2aa978a9255d8', class: {
                    'nav-panel': true,
                    'display-nav-panel': this.displayNavPanel,
                }, onClick: this.stopPropagationOfNavClick }, index.h("a", { key: 'addfb1cfba7601a247e9d242432da428a89370d3', class: "nav-panel__responsive-menu", onClick: this.toggleMenu }, index.h("span", { key: '4c0b3f1813c6dfc7a2a1f519bffa4a5ed109426d' }), index.h("span", { key: '9292fc50998a2c94986dba97203932bf8755e700' }), index.h("span", { key: '9a3bdc5917f668e47c89aa479dd4aaf2c6b055af' }), index.h("span", { key: '2e0af12be237f471f7004c48b803df053d07bc4b' })), index.h("header", { key: '656146ba6ad69eda77e1fe254020265c78748194', class: "panel-header" }, index.h("div", { key: '3a724ddd3bb51d151ebbd1fa30266f372fe63694', class: "branding-and-mode" }, index.h("h1", { key: '5974a364b58d1af4bfed568063dacced9595e69f' }, this.renderHeader()), index.h("kompendium-darkmode-switch", { key: 'f1e37e2f65518571b3dbd9caf09b75d14ac2eb29' })), index.h("kompendium-search", { key: '2d9bb94fbe8f7d4d72c21ebbdf832efbd8133aa7', index: this.index })), this.renderChapters(this.menu)),
        ];
    }
    renderHeader() {
...
const Search = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4c82e58e1125c690d0bd51d03b9bbe09b51789bb', class: "search-box" }, index.h("input", { key: '5be989a15423d662bc8de697bbbb64fa169a07ee', type: "search", autoFocus: true, placeholder: "Search", onInput: this.handleChangeInput }), index.h("ul", { key: 'a3742d729c7572fe2a27312033badb503005b328', class: classList }, this.documents.map(this.renderDocument))));
    }
    search(query) {
