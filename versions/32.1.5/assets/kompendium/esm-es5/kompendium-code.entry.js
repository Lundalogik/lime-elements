...
import { r as registerInstance, h, c as getElement } from './index-fb5abbae.js';
import { c as createCommonjsModule, a as commonjsGlobal } from './_commonjsHelpers-37a55ded.js';
...
var Code = /** @class */ (function () {
    ...
    Code.prototype.render = function () {
        ...
        return (h("pre", { class: classList }, h("slot", null), h("code", { class: "root" })));
    };
    Code.prototype.renderCode = function () {
        var container = this.host.shadowRoot.querySelector('.root');
        container.innerHTML = prism.highlight(this.findCode(), prism.languages[this.language]);
    };
    Code.prototype.findCode = function () {
        var slot = this.host.shadowRoot.querySelector('slot');
        return __spreadArrays(slot.assignedNodes()).map(function (node) { return node.textContent; })
            .join('');
    };
    Object.defineProperty(Code.prototype, "host", {
