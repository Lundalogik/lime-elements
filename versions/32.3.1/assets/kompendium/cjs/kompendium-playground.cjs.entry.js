...
const Playground = class {
  ...
  renderItem(source, index$1) {
    ...
    return (index.h("kompendium-code", { class: classList, language: source.type }, code));
  }
  renderDebugButton(tag) {
    ...
    return (index.h("div", { class: "debug" }, index.h("a", { class: "debug-link", href: href, title: "Debug" }, "Debug")));
  }
