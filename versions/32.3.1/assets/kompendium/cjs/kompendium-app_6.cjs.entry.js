...
const Navigation = class {
  ...
  render() {
    return (index.h("nav", { class: "nav-panel" }, index.h("a", { class: "nav-panel__responsive-menu", onClick: this.toggleMenu }, index.h("span", null), index.h("span", null), index.h("span", null), index.h("span", null)), index.h("header", { class: "panel-header" }, index.h("h1", null, this.renderHeader()), index.h("kompendium-search", { index: this.index })), this.renderChapters(this.menu)));
  }
  renderHeader() {
  ...
  renderMenuItem(item) {
    ...
    return (index.h("li", { class: "panel-item" }, index.h("a", { class: anchorClassList, href: '#' + item.path }, index.h("img", { src: path }), index.h("span", { class: "link-text" }, item.title)), index.h("ul", { class: classList }, chapters.map(this.renderMenuItem))));
  }
  isRouteActive(route) {
