...
(function(){
	...
	if (!ClipboardJS && typeof _commonjsHelpers.commonjsRequire === 'function') {
...
const Code = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "root" }, index.h("slot", null), index.h("pre", { class: classList }, index.h("code", null, this.code))));
  }
  findCode() {
