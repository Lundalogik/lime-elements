...
const LChart = class {
    ...
    render() {
        return (h("div", null, h("canvas", { class: "chart" })));
    }
    ...
    extendDatasetWithLimeColors(index, dataset, chartType) {
        ...
        return Object.assign(Object.assign({}, dataset), { backgroundColor: rgbColor.replace(')', ',' + bgOpacity + ')'), borderColor: rgbColor });
    }
    convertHex(hex) {
        const rEnd = 2;
        const gEnd = 4;
