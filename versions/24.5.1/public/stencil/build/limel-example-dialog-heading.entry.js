...
const DialogHeadingExample = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return [
            ...
            h("limel-dialog", { open: this.isOpen, onClose: this.closeDialog, heading: heading, class: classNames }, h("limel-input-field", { required: true, label: "Title", value: this.title, onChange: this.handleTitleChange }), h("limel-input-field", { label: "Subtitle", value: this.subtitle, onChange: this.handleSubtitleChange }), h("limel-input-field", { label: "Supporting text", value: this.supportingText, onChange: this.handleSupportingTextChange }), h("limel-select", { required: true, options: this.icons, label: "Icon", value: this.icon, onChange: this.handleIconChange }), h("limel-checkbox", { label: "Badge", checked: this.badge, onChange: this.handleBadgeChange }), h("limel-flex-container", { justify: "end", slot: "button" }, h("limel-button", { label: "Ok", primary: true, onClick: this.closeDialog }))),
        ];
    }
    openDialog() {
        this.isOpen = true;
...
export { DialogHeadingExample as limel_example_dialog_heading };
