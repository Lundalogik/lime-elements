import { r as registerInstance, h, g as getElement } from './index-b6960280.js';
...
const App = class {
  ...
  render() {
    ...
    return (h("div", { class: "kompendium-body" }, h("kompendium-navigation", { menu: this.data.menu, header: this.data.title, logo: this.data.logo, index: this.index }), h("main", { role: "main" }, h("kompendium-router", null, h("kompendium-route-switch", { scrollTopOffset: 0 }, h("kompendium-route", { url: "/", component: "kompendium-markdown", componentProps: {
...
export { App as kompendium_app, DarkmodeSwitch as kompendium_darkmode_switch, Navigation as kompendium_navigation, KompendiumRoute as kompendium_route, KompendiumRouteSwitch as kompendium_route_switch, KompendiumRouter as kompendium_router, Search as kompendium_search };
