...
class Props {
    ...
    render() {
        return h("div", { innerHTML: this.propsTableHtml });
    }
    fetchData(url) {
    ...
    stripBuiltWithStencilLine(data) {
        return data.replace(`----------------------------------------------

*Built with [StencilJS](https://stenciljs.com/)*`, '');
    }
    static get is() { return "limel-props"; }
