...
| `prefix`                  | `prefix`                    | <span style="color:red">**[DEPRECATED]**</span> Use `valuePrefix` instead. Will be removed in a future version.<br/><br/>The prefix which is displayed before the `value`, must be a few characters long.                     | `string`                                                   | `null`      |
...
| `suffix`                  | `suffix`                    | <span style="color:red">**[DEPRECATED]**</span> Use `valueSuffix` instead. Will be removed in a future version.<br/><br/>The suffix which is displayed after the `value`, must be one or two characters long. Defaults to `%` | `string`                                                   | `'%'`       |
| `value`                   | `value`                     | The value of the progress bar.                                                                                                                                                                                                | `number`                                                   | `0`         |
| `valuePrefix`             | `value-prefix`              | The prefix which is displayed before the `value`, must be a few characters long.                                                                                                                                              | `string`                                                   | `null`      |
| `valueSuffix`             | `value-suffix`              | The suffix which is displayed after the `value`, must be one or two characters long. Defaults to `%`                                                                                                                          | `string`                                                   | `null`      |
