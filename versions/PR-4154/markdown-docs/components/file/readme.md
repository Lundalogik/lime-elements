...
| `helperText` | `helper-text` | Optional helper text to display below the component. When the component is `invalid`, it is rendered as an error message.                                              | `string`                                                               | `undefined` |
...
### Used by
 ...
 - [limel-example-file-invalid](examples)
...
graph TD;
  ...
  limel-example-file-invalid --> limel-file
