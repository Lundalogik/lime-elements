...
| `progress` | `progress` | Reflects the progress of an ongoing process on the selected file, such as an upload, as a percentage. Must be a number between `0` and `100`.                          | `number`                                                               | `undefined` |
