 ...
 */
export function exampleAnchorId(docs, fallbackTag) {
 ...
 */
export function anchorHref(slug) {
 ...
 */
export function entrySlug(sectionSlug, name) {
 ...
 */
export function uniqueExampleSlugs(examples) {
