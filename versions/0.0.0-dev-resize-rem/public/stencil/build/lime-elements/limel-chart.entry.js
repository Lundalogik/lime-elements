...
class LChart {
    ...
    componentDidLoad() {
        ...
        const defaultFontSize = parseInt(this.getPropertyValue('font-size').replace('px', ''), 10);
        ...
        const canvas = this.element.shadowRoot.querySelector('.chart');
    ...
    getDatasetsWithColors(chartType) {
        return this.datasets.map((dataset, index) => {
            if (dataset.backgroundColor || dataset.borderColor) {
                return Object.assign({}, dataset);
            }
            else {
                return this.extendDatasetWithLimeColors(index, dataset, chartType);
            }
        });
    }
    extendDatasetWithLimeColors(index, dataset, chartType) {
        ...
        return Object.assign({}, dataset, { backgroundColor: rgbColor.replace(')', ',' + bgOpacity + ')'), borderColor: rgbColor });
    }
    convertHex(hex) {
        const rEnd = 2;
        const gEnd = 4;
