...
| ---------- | -------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `change`   | Fired when a new value has been selected from the picker | `CustomEvent<ListItem<number \| string> \| Array<ListItem<number \| string>>>` |
| `interact` | Fired when clicking on a selected value                  | `CustomEvent<Chip>`                                                            |
