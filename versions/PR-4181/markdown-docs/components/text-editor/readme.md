...
| `metadataChange` | <span style="color:red">**[DEPRECATED]**</span> Use the `inlineImages` prop instead. Will be removed in a future version.<br/><br/>Dispatched when the metadata of the editor changes                                                     | `CustomEvent<EditorMetadata>`     |
