...
| `totalRows`          | `total-rows`          | The number of total rows available for the data.  Leave it unset to page through the rows in `data`. Set it to `null` while a count is on its way, and the pagination holds its shape until the count arrives instead of collapsing to a single page and back.                                                                                                                                                                                                   | `number`                                                               | `undefined` |
