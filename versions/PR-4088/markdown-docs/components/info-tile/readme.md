...
| `reducePresence` | `reduce-presence` | Set to `true` to render the tile with a reduced visual presence — lower saturation and opacity, so the tile draws less attention.                                                                                                                                                                                                                                                                                                                                    | `boolean`          | `false`     |
...
### Used by
 ...
 - [limel-example-info-tile-reduce-presence](examples)
...
graph TD;
  ...
  limel-example-info-tile-reduce-presence --> limel-info-tile
