...
graph TD;
  ...
  limel-email-viewer --> limel-icon
  limel-example-button-disabled-vs-hidden --> limel-icon
  limel-example-collapsible-section-actions --> limel-icon
  limel-example-do-do-not --> limel-icon
  limel-example-header-menu --> limel-icon
  ...
  style limel-icon fill:#f9f,stroke:#333,stroke-width:4px
```
