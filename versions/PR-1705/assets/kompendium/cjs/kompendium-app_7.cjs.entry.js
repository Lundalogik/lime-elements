...
const Navigation = class {
  ...
  renderMenuItem(item) {
    ...
    return (index.h("li", { class: "panel-item" }, index.h("a", Object.assign({ class: anchorClassList, href: '#' + item.path }, anchorAdditionalProps), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24" }, index.h("path", { fill: "none", d: "M0 0h24v24H0z" }), index.h("path", { id: "arrow", d: "M13.172 12l-4.95-4.95 1.414-1.414L16 12l-6.364 6.364-1.414-1.414z", fill: "currentColor" })), index.h("span", { class: "link-text" }, item.title)), index.h("ul", { class: classList }, chapters.map(this.renderMenuItem))));
  }
  isRouteActive(route) {
