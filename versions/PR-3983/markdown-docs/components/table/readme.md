...
| `movableRows`        | `movable-rows`        | Set to `true` to enable reordering of the rows by dragging them. A drag handle will be rendered at the start of each row. Only available in `local` mode without pagination.                                                                                                                                                                                                                                                                                     | `boolean`                                                              | `undefined`  |
...
| `reorder`       | Emitted when a row has been reordered via drag-and-drop. The event detail describes which row was moved and where it was placed. | `CustomEvent<RowReorderEvent<any>>` |
