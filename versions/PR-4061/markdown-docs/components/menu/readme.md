...
| `rootItem`           | --                     | A root breadcrumb item to show above the menu items. Clicking it navigates back from a sub-menu to the root menu.                                                                                                                                  | `BreadcrumbsItem`                                                                                                                                                    | `{     text: '',     icon: {         name: 'home',     },     type: 'icon-only', }` |
