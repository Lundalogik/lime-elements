...
| `language`             | `language`               | Defines the language for translations. Affects the labels rendered by the picker itself, such as the "Results matching" header shown above the suggestion list while the user is typing.                                                                                                                                                                                                                                                                                                 | `"da" \| "de" \| "en" \| "en-gb" \| "fi" \| "fr" \| "nb" \| "nl" \| "no" \| "sv"` | `'en'`      |
