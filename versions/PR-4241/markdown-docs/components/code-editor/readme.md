...
| `translationLanguage` | `translation-language` | Defines the language for translations. Will translate the translatable strings on the components.                                                                                                                                          | `"da" \| "de" \| "en" \| "en-gb" \| "fi" \| "fr" \| "nb" \| "nl" \| "no" \| "sv"` | `'en'`      |
...
graph TD;
  ...
  limel-example-code-diff-interactive --> limel-code-editor
