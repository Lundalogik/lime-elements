...
const Playground = class {
    ...
    renderResult() {
        ...
        return (index.h("div", { class: "show-case" }, index.h("div", { class: "show-case_description" }, index.h("kompendium-markdown", { text: text })), index.h("div", { class: "show-case_component" }, index.h(ExampleComponent, null))));
    }
