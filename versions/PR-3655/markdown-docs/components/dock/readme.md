...
| `dockFooterItems`  | `dock-footer-items`  | Items that are placed at the bottom of the dock. (Or at the end in mobile layout.)                                                                                                                                                                                                                 | `DockItem[]` | `[]`                        |
| `dockItems`        | `dock-items`         | Items that are placed in the dock.                                                                                                                                                                                                                                                                 | `DockItem[]` | `[]`                        |
