...
| ------------------ | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------ |
| `actions`          | `actions`           | {@inheritdoc ListItem.selected}                                                                                                                                                                                                                                           | `(ListSeparator \| MenuItem<any>)[]`                                   | `undefined`  |
...
| `image`            | `image`             | {@inheritdoc ListItem.image}                                                                                                                                                                                                                                              | `Image`                                                                | `undefined`  |
...
| `primaryComponent` | `primary-component` | {@inheritdoc ListItem.selected}                                                                                                                                                                                                                                           | `ListComponent`                                                        | `undefined`  |
