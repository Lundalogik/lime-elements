...
| -------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `anchor`             | `anchor`               | The element that the content should be positioned relative to. Defaults to the limel-portal element.                                                                                                      | `HTMLElement`                                                                                                                                                        | `null`       |
| `containerId`        | `container-id`         | A unique ID.                                                                                                                                                                                              | `string`                                                                                                                                                             | `undefined`  |
| `containerStyle`     | `container-style`      | Dynamic styling that can be applied to the container holding the content.                                                                                                                                 | `object`                                                                                                                                                             | `{}`         |
