...
| ---------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------- |
| `accessibleItemsLabel` | `accessible-items-label` | Helps users of assistive technologies to understand what the items in the chart represent.                                                                                                                    | `string`                                                                                        | `undefined`     |
...
| `items` _(required)_   | `items`                  | List of items in the chart, each representing a data point.                                                                                                                                                   | `ChartItem<number \| [number, number]>[]`                                                       | `undefined`     |
