...
| `items`                 | `items`                    | Array of radio button options to display                                                                                                                                                                                                                              | `(ListSeparator \| ListItem<any>)[]` | `undefined` |
...
| `selectedItem`          | `selected-item`            | The currently selected item in the radio button group. This is a ListItem object that contains the value and other properties of the selected item. If no item is selected, this will be `undefined`.                                                                 | `ListItem<string \| number>`         | `undefined` |
