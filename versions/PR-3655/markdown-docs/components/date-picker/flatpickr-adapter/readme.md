...
| `formatter` _(required)_ | `formatter`     |                                                                                                                        | `(date: Date) => string`                                                     | `undefined`  |
| `inputElement`           | `input-element` | The native input element to use with flatpickr.                                                                        | `HTMLElement`                                                                | `undefined`  |
