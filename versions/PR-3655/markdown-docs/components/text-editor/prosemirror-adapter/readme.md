...
| `customElements`    | `custom-elements`    | set to private to avoid usage while under development                                                                                                                                                                                   | `CustomElementDefinition[]`                                            | `[]`         |
...
| `triggerCharacters` | `trigger-characters` | set to private to avoid usage while under development                                                                                                                                                                                   | `TriggerCharacter[]`                                                   | `[]`         |
