...
| `whitelist`      | `whitelist`        | Whitelisted html elements.  Any custom element added here will not be sanitized and thus rendered. Can also be set via `limel-config`. Setting this property will override the global config. | `CustomElementDefinition[]` | `globalConfig.markdownWhitelist` |
