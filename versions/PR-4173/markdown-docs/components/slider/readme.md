...
| `value`                    | `value`                      | The value of the input. When the value is `NaN`, `null`, `undefined`, or otherwise not a finite number, the slider is considered unset.                                                                                                              | `number`                                                               | `undefined` |
