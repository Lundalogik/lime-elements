...
| `has3dEffect` | `has-3d-effect` | When `true`, the card displays a glow effect on hover, following the 3D tilt hover effect. By deafult, set to `true`.                                       | `boolean`                            | `true`       |
...
### Used by
 ...
 - [limel-example-card-selected](examples)
...
graph TD;
  ...
  limel-example-card-selected --> limel-card
