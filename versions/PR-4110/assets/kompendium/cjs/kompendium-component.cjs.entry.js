...
function ExampleList({ examples, id, schema, propsFactory, }) {
    ...
    return [
        index.h("h2", { class: "docs-layout-section-heading", id: id }, "Examples"),
...
const KompendiumComponent = class {
    ...
    componentDidLoad() {
        const route = anchorScroll.getRoute().split('#')[0];
        anchorScroll.scrollToElement(this.host.shadowRoot, route);
    }
    componentDidUpdate() {
    ...
    handleRouteChange() {
        this.scrollToOnNextUpdate = anchorScroll.getRoute().split('#')[0];
    }
    render() {
        const tag = this.match.params.name;
        const component = findComponent(tag, this.docs);
        return (index.h("article", { key: '073cbc79fc02638eaae6e83f81a245d167e28668', class: "component" }, index.h("section", { key: '2ebeac246746ef80d1e5cbd7ed13e5a077a15d2e', class: "docs" }, this.renderDocs(tag, component))));
    }
