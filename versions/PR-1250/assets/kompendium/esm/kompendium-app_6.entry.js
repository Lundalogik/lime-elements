...
const Navigation = class {
  ...
  render() {
    return (h("nav", { class: "nav-panel" }, h("a", { class: "nav-panel__responsive-menu", onClick: this.toggleMenu }, h("span", null), h("span", null), h("span", null), h("span", null)), h("header", { class: "panel-header" }, h("h1", null, this.renderHeader()), h("kompendium-search", { index: this.index })), this.renderChapters(this.menu)));
  }
  renderHeader() {
