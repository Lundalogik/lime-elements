...
| `searchResultsLabel`   | `search-results-label`   | Optional label rendered as a separator above the suggestion list when the user has typed something. Use `{query}` as a placeholder for the current search text. Example: `'Hits containing "{query}"'`.  If unset, no separator is shown — the dropdown looks the same as before.                                                                                                                                                                                                        | `string`                                                                   | `undefined` |
