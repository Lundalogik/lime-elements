...
| `message`     | `message`     | The message to display.  Supports [Markdown](#/component/limel-markdown/) for light inline emphasis such as `**bold**` or `*italic*`. See the Markdown example below for UX guidance.                                                                                                             | `string`                                                               | `undefined` |
