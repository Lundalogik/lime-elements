...
import { a as dispatchResizeEvent } from './chunk-5cf55c19.js';
...
class CollapsibleSection {
    ...
    render() {
        return (h("section", { class: `${this.isOpen ? 'open' : ''}` },
            h("header", { onClick: this.onClick.bind(this) },
                h("span", { class: "expander" },
                    h("svg", { viewBox: "0 0 30 30", width: "100%", height: "100%" }, (() => {
                        if (this.isOpen) {
                            return (h("path", { d: "M15.5 12.246l1.008 1.008L21 17.746l-1.008 1.008-4.492-4.491-4.492 4.492L10 17.746l4.492-4.492 1.008-1.008z" }));
                        }
                        return (h("path", { d: "M15.5 19l1.008-1.008L21 13.5l-1.008-1.008-4.492 4.491-4.492-4.492L10 13.5l4.492 4.492L15.5 19z" }));
                    })())),
                h("h5", { class: "mdc-typography mdc-typography--headline5" }, this.header)),
            h("div", { class: "body" },
                h("slot", null))));
    }
    onClick() {
...
export { CollapsibleSection as LimelCollapsibleSection, CollapsibleSectionExample as LimelExampleCollapsibleSection };
