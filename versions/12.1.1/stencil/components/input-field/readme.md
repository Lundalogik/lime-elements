...
| -------- | ------------------------------------------------------------------------------------------------------------------ | ------ |
| `action` | This event is tied to the `trailingIcon` property, which doesn't work at the moment. Don't use it.                 | void   |
| `change` | Emitted when the input value is changed. The new value is available via the `detail` property on the event object. | void   |
