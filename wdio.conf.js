exports.config = {
    ...
    // services: ['selenium-standalone','static-server','chromedriver','iedriver','screenshots-cleanup'],
    ...
    reporters: [process.env.CI ? 'junit' : 'slick'],
    ...
    // ===========================
    // https://github.com/LeadPages/wdio-static-server-service#options
