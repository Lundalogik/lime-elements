...
Vous pouvez laisser les images bloquées (l'e-mail peut sembler incomplet) ou les charger si vous faites confiance à l'expéditeur.`,
    ...
    'editor-menu.highlight': 'Surligner',
    'editor-menu.highlight-color-tooltip': 'Choisir la couleur de surlignage',
    ...
    'editor-highlight-color-menu.color': 'Couleur de surlignage',
    'editor-highlight-color-menu.tooltip': 'Choisir une couleur',
    'editor-highlight-color-menu.helper':
        'Utilisée comme couleur de fond du texte surligné.',
    ...
    'ai-avatar.mode.active': 'actif',
    'ai-avatar.mode.thinking': 'en réflexion',
    'ai-avatar.mode.typing': 'en train d’écrire',
    'ai-avatar.mode.working': 'au travail',
    'ai-avatar.mode.waiting': 'en attente de saisie',
