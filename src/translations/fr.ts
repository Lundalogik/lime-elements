export default {
    ...
    'code-editor.copy': 'Copier dans le presse-papiers',
    'code-editor.copied': 'Copié dans le presse-papiers',
    'code-editor.copy-failed': 'Échec de la copie dans le presse-papiers',
