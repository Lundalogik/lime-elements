...
Sie können Bilder weiterhin blockieren (die E-Mail kann unvollständig aussehen) oder sie laden, wenn Sie dem Absender vertrauen.`,
    ...
    'editor-menu.highlight': 'Hervorheben',
    'editor-menu.highlight-color-tooltip': 'Hervorhebungsfarbe auswählen',
    ...
    'editor-highlight-color-menu.color': 'Hervorhebungsfarbe',
    'editor-highlight-color-menu.tooltip': 'Farbe auswählen',
    'editor-highlight-color-menu.helper':
        'Wird als Hintergrundfarbe des hervorgehobenen Textes verwendet.',
