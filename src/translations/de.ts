export default {
    ...
    'code-editor.copy': 'In die Zwischenablage kopieren',
    'code-editor.copied': 'In die Zwischenablage kopiert',
    'code-editor.copy-failed': 'Kopieren in die Zwischenablage fehlgeschlagen',
