...
You can keep images blocked (the email may look incomplete), or load them if you trust the sender.`,
    ...
    'editor-menu.highlight': 'Highlight',
    'editor-menu.highlight-color-tooltip': 'Choose your highlight color',
    ...
    'editor-highlight-color-menu.color': 'Highlight color',
    'editor-highlight-color-menu.tooltip': 'Pick a color',
    'editor-highlight-color-menu.helper':
        'Used as the background color of the highlighted text.',
    ...
    'ai-avatar.mode.active': 'active',
    'ai-avatar.mode.thinking': 'thinking',
    'ai-avatar.mode.typing': 'typing',
    'ai-avatar.mode.working': 'working',
    'ai-avatar.mode.waiting': 'waiting for input',
    ...
    'code-diff.diff-summary':
        'Diff: { parts }. Use arrow keys to navigate lines.',
