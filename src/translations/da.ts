...
Du kan fortsætte med at blokere billeder (e-mailen kan se ufuldstændig ud) eller indlæse dem, hvis du stoler på afsenderen.`,
    ...
    'editor-menu.highlight': 'Fremhæv',
    'editor-menu.highlight-color-tooltip': 'Vælg fremhævningsfarve',
    ...
    'editor-highlight-color-menu.color': 'Fremhævningsfarve',
    'editor-highlight-color-menu.tooltip': 'Vælg en farve',
    'editor-highlight-color-menu.helper':
        'Bruges som baggrundsfarve for den fremhævede tekst.',
    ...
    'code-diff.diff-summary':
        'Diff: { parts }. Brug piletasterne til at navigere.',
