...
export class RadioButtonGroupMultipleLinesExample {
    @State()
    private selectedPlan: string = 'basic';
    ...
    private plans: Array<ListItem<string>> = [
        {
            text: 'Basic Plan',
            secondaryText:
    ...
    public render() {
        return [
            ...
            <limel-example-value value={this.selectedPlan} />,
        ];
    }
    ...
    private handlePlanChange = (event: CustomEvent<string>) => {
