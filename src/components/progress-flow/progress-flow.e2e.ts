...
describe('limel-progress-flow', () => {
    ...
    describe('when the progress flow contains three steps', () => {
        ...
        it('renders the passed step correctly', () => {
            ...
            expect(passedStep).not.toHaveClass('active');
        });

        it('renders the active step correctly', () => {
            const activeStep = progressFlowItems[1];
            expect(activeStep).toHaveClass('active');
            expect(activeStep).not.toHaveClass('passed');
        });
        ...
        it('renders forthcoming step correctly', () => {
            ...
            expect(forthcomingSteps).not.toHaveClass('active');
        });
