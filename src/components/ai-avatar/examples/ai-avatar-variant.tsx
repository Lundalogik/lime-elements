 ...
 */
@Component({
    tag: 'limel-example-ai-avatar-variant',
    shadow: true,
    styleUrl: 'ai-avatar-basic.scss',
})
export class AiAvatarVariantExample {
    public render() {
        return (
            <Host>
                <div class="variants">
                    <div>
                        <limel-ai-avatar variant="detailed" />
                        <code>detailed</code>
                    </div>
                    <div>
                        <limel-ai-avatar variant="minimal" />
                        <code>minimal</code>
                    </div>
                    <div>
                        <limel-ai-avatar variant="solid" />
                        <code>solid</code>
                    </div>
                    <div>
                        <limel-ai-avatar variant="outlined" />
                        <code>outlined</code>
                    </div>
                </div>
            </Host>
