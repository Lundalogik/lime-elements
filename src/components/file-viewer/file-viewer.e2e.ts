...
describe('limel-file-viewer', () => {
    ...
    describe('with image', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="image/jpg" url="cat.gif"></limel-file-viewer>
            `);
        ...
        it('removes the image when url is cleared', async () => {
    ...
    describe('with pdf', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="application/pdf" url="file.pdf"></limel-file-viewer>
            `);
        ...
        it('displays the pdf using the object element', () => {
            ...
            expect(contentElement.getAttribute('type')).toEqualText(
                'application/pdf'
            );
        });
    ...
    describe('with text', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="text/plain" url="file.txt"></limel-file-viewer>
            `);
            contentElement = await page.find('limel-file-viewer>>>object');
        });
    ...
    describe('with video', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="video/mkv" url="file.mkv"></limel-file-viewer>
            `);
        ...
        it('displays the video using the video element', async () => {
            ...
            expect(sourceElement.getAttribute('type')).toEqualText('video/mkv');
        });
        it('does not show button controls', async () => {
            const buttons = await page.find('limel-file-viewer>>>div.buttons');
            expect(buttons).toBeNull();
    ...
    describe('with audio', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="audio/mp3" url="file.mp3"></limel-file-viewer>
            `);
        ...
        it('displays the audio using the audio element', async () => {
            ...
            expect(sourceElement.getAttribute('type')).toEqualText('audio/mp3');
        });
        it('does not show button controls', async () => {
            const buttons = await page.find('limel-file-viewer>>>div.buttons');
            expect(buttons).toBeNull();
    ...
    describe('without url', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer type="text/plain"></limel-file-viewer>
            `);
    ...
    describe('without type', () => {
        beforeEach(async () => {
            page = await createPage(`
                <limel-file-viewer url="/"></limel-file-viewer>
            `);
            contentElement = await page.find('limel-file-viewer>>>*');
        });
        it('shows file preview is not supported', () => {
            expect(contentElement).toHaveClass('no-support');
        });
    });
});
