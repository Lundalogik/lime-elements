...
The recommended icon library for use with Lime Elements is the Windows 10 set from Icons8 (https://icons8.com/windows-icons/). This set is included in the relevant Lime products. If you are using Lime Elements in a non-Lime product, you will have to supply your own icons.
