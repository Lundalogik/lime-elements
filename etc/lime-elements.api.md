...
namespace JSX_2 {
    ...
    interface LimelActionBar {
        ...
        layout?: 'fullWidth' | 'floating';
        onItemSelected?: (
            event: LimelActionBarCustomEvent<ActionBarItem>,
        ) => void;
        openDirection?: OpenDirection;
    }
    // (undocumented)
    interface LimelActionBarItem {
        ...
        item: ActionBarItem | ListSeparator;
        onSelect?: (
            event: LimelActionBarItemCustomEvent<ActionBarItem | ListSeparator>,
        ) => void;
    }
    // (undocumented)
    interface LimelActionBarOverflowMenu {
        items?: Array<MenuItem | ListSeparator>;
        onSelect?: (
            event: LimelActionBarOverflowMenuCustomEvent<ActionBarItem>,
        ) => void;
        openDirection?: OpenDirection;
    }
    ...
    interface LimelPicker {
        ...
        onInteract?: (
            event: LimelPickerCustomEvent<ListItem<number | string>>,
        ) => void;
        readonly?: boolean;
        required?: boolean;
        searcher?: Searcher;
    ...
    interface LimelSelect {
        ...
        multiple?: boolean;
        onChange?: (
            event: LimelSelectCustomEvent<Option_2 | Option_2[]>,
        ) => void;
        options?: Option_2[];
        readonly?: boolean;
        required?: boolean;
...
//
// @public (undocumented)
export interface LimelActionBarOverflowMenuCustomEvent<T>
